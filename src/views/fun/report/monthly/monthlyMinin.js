		...
		return {
			...
			columns: [
				...
				},
				{
					...
					width: 700,
					scopedSlots: { customRender: "questionDescription" },
				},
				{
					title: "检查日期",
					dataIndex: "checkDate",
				...
				},
				{
					...
					align: "center",
					width: 70,
					scopedSlots: { customRender: "implementation" },
				},
				{
					title: "操作",
					dataIndex: "operation",
			...
			jobmonitorColumns: [
				...
				},
				{
					...
					align: "center",
					width: 75,
					scopedSlots: { customRender: "workDept" },
				},
				{
					title: "监护人是否在现场履职",
					dataIndex: "isWork",
					...
					align: "center",
					width: 75,
					scopedSlots: { customRender: "isWork" },
				},
				{
					title: "存在的问题",
					dataIndex: "workQuestion",
					width: 50,
					align: "center",
					width: 75,
					scopedSlots: { customRender: "workQuestion" },
				},
				{
					title: "操作",
					dataIndex: "operation",
			...
			practiceColumns: [
				...
				{
					title: "文字内容",
					dataIndex: "practiceSummaryInfo",
					width: 750,
					align: "center",
					scopedSlots: { customRender: "practiceSummaryInfo" },
				},
